...
run_program() {
    ...
    do
        ...
        echo "Time taken by contraction 1 for Run $i : $seconds_1"
        echo "Time taken by contraction 2 for Run $i : $seconds_2"
    ...
    echo "Total Time taken by contraction 1 for $num_executions runs : $total_seconds_1"
    echo "Total Time taken by contraction 2 for $num_executions runs : $total_seconds_2"
    ...
    echo "Average Time taken by contraction 1 for $num_executions runs : $avg_seconds_1"
    echo "Average Time taken by contraction 2 for $num_executions runs : $avg_seconds_2"
