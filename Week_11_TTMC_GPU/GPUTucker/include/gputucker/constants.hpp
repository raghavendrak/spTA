...
constexpr int kMaxIteration{50};   ///< Default maximum number of iterations for the algorithm.
constexpr double kLambda{0.0001f}; ///< Default convergence tolerance for the observed-entry fit.
} // namespace constants
